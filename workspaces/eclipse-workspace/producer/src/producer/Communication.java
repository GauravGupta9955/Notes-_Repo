...
class Producer extends Thread {
	...
	//Varible use by thread for Communication
...
class Consumer extends Thread {
	...
	public void run() {
		...
		//checks for the Producer  dataprovider for dataprovider variable
		//if true only consume the data
