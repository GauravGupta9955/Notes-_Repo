...
/**
 * Servlet implementation class DemoServletWithAnnotation
 */
@WebServlet(
		urlPatterns = { "/DemoServletWithAnnotation" }, 
		initParams = { 
				@WebInitParam(name = "Company", value = "Ineuron"), 
				@WebInitParam(name = "Course", value = "EnterpriseJava"), 
				@WebInitParam(name = "Mentor", value = "naveenReddy")
		})
public class DemoServletWithAnnotation extends HttpServlet {
	...
	public DemoServletWithAnnotation() {
